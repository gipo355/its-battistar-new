...
-   **its-battistar-angular:** :sparkles: make it just a tiny bit more
    responsive
...
-   **its-battistar-angular:** :sparkles: converted and cleaned up the modal
    flow to prepare for http
...
-   **its-battistar-angular:** :sparkles: modal changes, temporary creation
    before DB, closes [#53](https://github.com/gipo355/its-battistar/issues/53)
...
-   **its-battistar:** :sparkles: all filters implemented for todos in
    todo-filter comp
...
-   **its-battistar:** :sparkles: init todos component with modal, pre
    converting to todos routes
...
-   **its-battistar:** :sparkles: todo-item, prepare mocks for storybook to
    style the card
...
-   **its-battistar:** :bug: fix flowbite not loading javascript. requires init
    on lazy loaded comps
