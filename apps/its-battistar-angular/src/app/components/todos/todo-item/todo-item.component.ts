...
export class TodoItemComponent {
    ...
    colorSchema: Record<keyof typeof ETodoColorOptions, string> = {
        ...
        green: 'bg-green-300 before:bg-green-300 dark:before:bg-green-500 bg-opacity-50',
        blue: 'bg-blue-300 before:bg-blue-300 dark:before:bg-blue-500 bg-opacity-50',
        yellow: 'bg-yellow-300 before:bg-yellow-300 dark:before:bg-yellow-500 bg-opacity-50',
